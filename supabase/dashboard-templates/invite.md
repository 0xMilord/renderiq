...
2. Navigate to: **Authentication → Email Templates → Invite user**
3. Open the HTML file: `invite.html`
...
<head>
  ...
  <title>You're Invited to Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      <h2>You're Invited to Renderiq</h2>
      <p>Hi there,</p>
      <p>You have been invited to join Renderiq! Click the button below to accept the invitation and create your account.</p>
