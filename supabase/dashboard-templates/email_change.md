...
2. Navigate to: **Authentication → Email Templates → Change email address**
3. Open the HTML file: `email_change.html`
...
<head>
  ...
  <title>Confirm Email Change - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>You are requesting to update your email address to <strong>{{ .NewEmail }}</strong>.</p>
      ...
      <p style="color: #6b7280; font-size: 14px;">If you didn't request to change your email, please ignore this email or contact support immediately.</p>
    </div>
    <div class="footer">
