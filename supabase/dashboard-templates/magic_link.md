...
3. Open the HTML file: `magic_link.html`
...
<head>
  ...
  <title>Your Magic Link - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>Click the button below to sign in to your Renderiq account. This link will automatically log you in.</p>
      <p style="text-align: center;">
        <a href="{{ .ConfirmationURL }}" class="button">Sign In to Renderiq</a>
      </p>
      ...
      <p style="color: #6b7280; font-size: 14px; margin-top: 24px;">⏰ This link will expire in 1 hour.</p>
      <p style="color: #6b7280; font-size: 14px;">If you didn't request this magic link, you can safely ignore this email.</p>
    </div>
    <div class="footer">
