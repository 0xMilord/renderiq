...
2. Navigate to: **Authentication → Email Templates → Security → Phone number changed**
3. Open the HTML file: `phone_changed.html`
...
<head>
  ...
  <title>Phone Number Changed - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>The phone number for your Renderiq account has been changed from <strong>{{ .OldPhone }}</strong> to <strong>{{ .Phone }}</strong>.</p>
      <div class="alert">
