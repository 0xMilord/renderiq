...
2. Navigate to: **Authentication → Email Templates → Security → Identity unlinked**
3. Open the HTML file: `identity_unlinked.html`
...
<head>
  ...
  <title>Account Unlinked - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      <h2>Account Unlinked</h2>
      <p>Hi there,</p>
      <p>An identity ({{ .Provider }}) has been unlinked from your Renderiq account.</p>
      <div class="alert">
        <strong>⚠️ Security Notice:</strong> If you didn't unlink this account, please contact our support team immediately.
      </div>
