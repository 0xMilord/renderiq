...
2. Navigate to: **Authentication → Email Templates → Security → Email address changed**
3. Open the HTML file: `email_changed.html`
...
<head>
  ...
  <title>Email Address Changed - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>The email address for your Renderiq account has been changed from <strong>{{ .OldEmail }}</strong> to <strong>{{ .Email }}</strong>.</p>
      <div class="alert">
        <strong>⚠️ Security Notice:</strong> If you didn't make this change, please contact our support team immediately.
      </div>
      <p>If this was you, no further action is needed. All future emails will be sent to your new address.</p>
    </div>
    <div class="footer">
