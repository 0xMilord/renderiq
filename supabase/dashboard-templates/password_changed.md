...
2. Navigate to: **Authentication → Email Templates → Security → Password changed**
3. Open the HTML file: `password_changed.html`
...
<head>
  ...
  <title>Password Changed - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>The password for your Renderiq account has been successfully changed.</p>
      <div class="alert">
