...
2. Navigate to: **Authentication → Email Templates → Reauthentication**
3. Open the HTML file: `reauthentication.html`
...
<head>
  ...
  <title>Confirm Reauthentication - Renderiq</title>
  <style>
    body {
...
<body>
  <div class="container">
    ...
    <div class="content">
      ...
      <p>Hi there,</p>
      <p>You need to re-authenticate to perform a sensitive action. Use the one-time password below:</p>
      <div class="otp-code">{{ .Token }}</div>
      <p style="text-align: center;">
        <a href="{{ .ConfirmationURL }}" class="button">Confirm</a>
      </p>
      <p style="color: #6b7280; font-size: 14px; margin-top: 24px;">⏰ This code will expire in 10 minutes.</p>
      <p style="color: #6b7280; font-size: 14px;">If you didn't request this, please contact support immediately.</p>
    </div>
    <div class="footer">
