  ...
  return (
    <motion.span
      className={cn(
        ...
        bordered && "border border-current/20",
        className
      )}
    >
      {flicker && (
      ...
      <motion.span
        ...
        className="relative z-10 inline-flex items-center leading-none"
      >
        {content}
      </motion.span>
      ...
      {showIcons && (
        <>
          <Icon
            className={cn(
              "absolute top-0 left-0 -translate-x-1/2 -translate-y-1/2 h-3 w-3 text-current",
              iconClassName
            )}
          />
          <Icon
            className={cn(
              "absolute bottom-0 left-0 -translate-x-1/2 translate-y-1/2 h-3 w-3 text-current",
              iconClassName
            )}
          />
          <Icon
            className={cn(
              "absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 h-3 w-3 text-current",
              iconClassName
            )}
          />
          <Icon
            className={cn(
              "absolute bottom-0 right-0 translate-x-1/2 translate-y-1/2 h-3 w-3 text-current",
              iconClassName
            )}
          />
        </>
