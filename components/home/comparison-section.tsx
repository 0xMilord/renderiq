...
export function ComparisonSection() {
  const renderCell = (value: boolean | string, isRenderiq: boolean = false) => {
    ...
    return (
      <span className={`text-base sm:text-lg font-medium ${isRenderiq ? 'text-primary' : 'text-foreground'}`}>
        {value}
      </span>
    );
  };
  ...
  return (
    <section id="comparison" className="py-12 sm:py-16 lg:py-20 px-0 bg-background w-full">
