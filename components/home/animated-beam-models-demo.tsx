...
import { SiGooglegemini, SiOpenai, SiClaude } from "react-icons/si"
...
const RoundedSquare = forwardRef<
  HTMLDivElement,
...
>(({ className, children }, ref) => {
  ...
  const isLarge = className?.includes("size-14")
  
  return (
    <div 
      ref={ref}
      className={cn(
        "rounded-xl p-[5px] relative z-20",
    ...
    >
      <div className={cn(
        ...
        <div
          className={cn(
            "flex items-center justify-center rounded-md border border-border overflow-hidden",
    ...
    >
      <div className="flex size-full max-w-lg flex-row items-stretch justify-between gap-4">
        <div className="flex flex-col justify-center gap-2">
          <RoundedSquare ref={div1Ref}>
            <SiGooglegemini className="w-full h-full text-foreground" />
          </RoundedSquare>
          <RoundedSquare ref={div2Ref}>
            <SiOpenai className="w-full h-full text-foreground" />
          </RoundedSquare>
          <RoundedSquare ref={div3Ref}>
            <RiPerplexityFill className="w-full h-full text-foreground" />
          </RoundedSquare>
          <RoundedSquare ref={div4Ref}>
            <SiClaude className="w-full h-full text-foreground" />
          </RoundedSquare>
          <RoundedSquare ref={div5Ref}>
            <Plus className="w-full h-full text-muted-foreground" />
          </RoundedSquare>
        </div>
        <div className="flex flex-col justify-center">
          <RoundedSquare ref={div6Ref} className="size-14">
            <Image
