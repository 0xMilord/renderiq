  ...
  offers: [
    {
      ...
      price: '0',
      priceCurrency: 'USD',
      description: '25 free credits to get started with AI rendering'
    },
    {
      '@type': 'Offer',
      name: 'Starter Plan',
...
export const comprehensiveFAQSchema = {
  ...
  mainEntity: [
    ...
    },
    {
      ...
      acceptedAnswer: {
        '@type': 'Answer',
        text: 'We offer a free plan with 25 credits to get started. Our Starter plan is $7.99/month (₹799) with 100 credits, Pro plan is $24.99/month (₹2,499) with 400 credits, and Enterprise plan is $64.99/month (₹6,499) with 1,200 credits. Annual plans available with 20-25% savings.'
      }
    },
    {
      '@type': 'Question',
