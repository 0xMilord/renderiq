...
export function StyleReferenceNode(props: any) {
  ...
  const [localData, setLocalData] = useState<StyleReferenceNodeData>(() => {
    if (data) {
      return {
        ...
        styleExtraction: data.styleExtraction || {
          extractCamera: true,
    ...
    if (data) {
      setLocalData((prev) => {
        ...
        return {
          ...
          extractedStyle: data.extractedStyle !== undefined ? data.extractedStyle : prev.extractedStyle,
          styleExtraction: data.styleExtraction || prev.styleExtraction,
        };
      });
    }
  }, [data]);
