...
/**
 * Lasso Select Tool for Renderiq Canvas
 * Allows freehand drawing to select shapes on the canvas
 */
...
export class LassoingState extends StateNode {
	...
	// Reactive atom to store lasso points
	...
	private doesLassoFullyContainShape(lassoPoints: VecModel[], shape: TLShape): boolean {
		...
		// If any shape edges intersect with the lasso, then we know it can't be fully contained
