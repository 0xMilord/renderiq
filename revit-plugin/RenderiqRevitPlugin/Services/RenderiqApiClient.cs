...
namespace RenderiqRevitPlugin.Services
{
    ...
    /// Follows the unified plugin API architecture
    /// </summary>
    public class RenderiqApiClient
    {
        ...
        public RenderiqApiClient(string accessToken = null)
        {
            ...
            _httpClient.DefaultRequestHeaders.Add("X-Renderiq-Platform", "revit");
            _httpClient.DefaultRequestHeaders.Add("User-Agent", "Renderiq-Revit-Plugin/1.0.0");
