...
export const metadata: Metadata = {
  title: "Terms of Service | AecoSec - AI Architectural Visualization",
  description: "Read the terms and conditions for using AecoSec's AI architectural visualization and rendering platform.",
  robots: "index, follow"
};
...
const sections = [
  {
    ...
    content: [
      {
        text: "By accessing or using AecoSec's platform, you agree to be bound by these Terms of Service and all applicable laws and regulations. If you do not agree with any part of these terms, you may not use our services."
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "The AecoSec platform, including its software, AI models, design, and functionality, is owned by us and protected by copyright, trademark, and other intellectual property laws."
      },
      {
...
const additionalSections = [
  ...
  },
  {
    ...
    content: [
      "You agree to indemnify and hold harmless AecoSec, its affiliates, and employees from any claims, damages, or expenses arising from your use of the platform or violation of these terms.",
  ...
  },
  {
    ...
    content: [
      ...
      "You may opt out of arbitration within 30 days of account creation by contacting legal@aecosec.com."
    ]
  }
];
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-base text-muted-foreground max-w-2xl mx-auto">
            Please read these terms carefully before using AecoSec's AI architectural visualization platform.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="mt-12">
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-sm">
                <p><strong>Email:</strong> legal@aecosec.com</p>
                <p><strong>Support:</strong> support@aecosec.com</p>
          ...
          <div className="mt-12 p-6 bg-muted/50 rounded-lg">
            ...
            <p className="text-sm text-muted-foreground">
              By using AecoSec's platform, you acknowledge that you have read, understood, and agree 
