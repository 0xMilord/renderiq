      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-card">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Join thousands of architects and designers who trust AecoSec for their visualization needs
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div className="bg-background border border-border rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
              ...
              <p className="text-muted-foreground mb-6">
                &ldquo;AecoSec has revolutionized how we present our designs to clients. The AI renders are so realistic that clients can immediately visualize the final result. It&apos;s saved us countless hours of manual rendering work.&rdquo;
              </p>
            ...
            <div className="bg-background border border-border rounded-2xl p-8 hover:shadow-lg transition-shadow duration-300">
              ...
              <Quote className="h-8 w-8 text-primary mb-4" />
              <p className="text-muted-foreground mb-6">
                &ldquo;As a freelance architect, AecoSec has given me the tools to compete with larger firms. The quality of renders I can produce now is professional-grade, and it&apos;s helped me win more projects.&rdquo;
              </p>
              <div className="flex items-center">
                <div className="w-12 h-12 bg-primary rounded-full flex items-center justify-center mr-4">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-primary relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative">
          ...
          <p className="text-xl md:text-2xl text-primary-foreground/80 mb-12 max-w-4xl mx-auto">
            Join thousands of architects and designers creating stunning visualizations with AecoSec
          </p>
