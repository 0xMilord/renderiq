...
export const metadata: Metadata = {
  title: "Real-Time Architectural Visualization with AI | Instant Rendering | AecoSec",
...
export default function RealTimeVisualizationPage() {
  return (
    <div className="min-h-screen bg-background">
      ...
      {/* Hero Section */}
      <section className="py-20 px-4 bg-gradient-to-b from-blue-500/5 to-background">
