          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Get renders in minutes with our optimized pipeline</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
            ...
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Simple REST API with comprehensive documentation</p>
              </div>
            </div>
            <div className="flex items-start space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-600 text-sm">Fast delivery worldwide with our global CDN</p>
              </div>
            </div>
          </div>
        </div>
...
{`curl -H "Authorization: Bearer YOUR_API_KEY" \\
     ...
     https://api.aecosec.com/v1/renders`}
          ...
          <p className="text-sm text-gray-600">
            Get your API key from the <a href="/dashboard" className="text-blue-600 hover:underline">dashboard</a>.
          </p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          {/* Create Render */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Create Render</h3>
...
{`{
  ...
  "data": {
    ...
    "estimated_completion": "2024-01-15T10:30:00Z"
          ...
          {/* Get Render Status */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-3">Get Render Status</h3>
            <div className="bg-gray-100 rounded-lg p-3 mb-3">
...
{`{
  ...
  "data": {
    ...
    "processing_time": 45
          ...
          {/* List Renders */}
          <div className="mb-8">
            <h3 className="text-xl font-semibold text-gray-900 mb-3">List Renders</h3>
            <div className="bg-gray-100 rounded-lg p-3 mb-3">
        ...
        <div className="bg-white rounded-lg shadow-md p-8 mb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="border border-gray-200 rounded-lg p-4">
              ...
              <a href="#" className="text-blue-600 text-sm hover:underline">View Docs →</a>
            </div>
