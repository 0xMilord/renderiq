...
export const metadata: Metadata = {
  title: "Privacy Policy | arqihive - AI Architectural Visualization",
  description: "Learn how arqihive protects your data and privacy. Our commitment to security and transparency in AI architectural design and rendering.",
  robots: "index, follow"
};
      ...
      <section className="py-20 px-4 bg-gradient-to-b from-primary/5 to-background">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-base text-muted-foreground max-w-2xl mx-auto">
            At arqihive, we take your privacy seriously. This policy explains how we collect, 
          ...
          <Card className="mt-12">
            ...
            <CardContent>
              ...
              <div className="space-y-2 text-sm">
                <p><strong>Email:</strong> privacy@arqihive.com</p>
                <p><strong>Data Protection Officer:</strong> dpo@arqihive.com</p>
              </div>
