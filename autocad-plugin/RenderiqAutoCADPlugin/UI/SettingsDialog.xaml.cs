    ...
    public partial class SettingsDialog : Window
    {
        ...
        private void SaveButton_Click(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                _settings.DefaultStyle = (DefaultStyleComboBox.SelectedItem as System.Windows.Controls.ComboBoxItem)?.Content?.ToString()?.ToLower() ?? "photorealistic";
                _settings.DefaultAspectRatio = (DefaultAspectComboBox.SelectedItem as System.Windows.Controls.ComboBoxItem)?.Content?.ToString() ?? "16:9";
